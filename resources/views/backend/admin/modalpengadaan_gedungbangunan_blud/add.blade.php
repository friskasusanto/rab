			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li class="active">Belanja Modal Pengadaan Gedung & Bangunan BLUD</li>
							<a href="{{action('backend\AdminController@list_bangunan_blud')}}">
					...
					<div class="section-body contain-lg">
						...
						<div class="row">
							...
							<div class="col-lg-offset-1 col-md-10">
								<form class="form form-validate floating-label" novalidate="novalidate" method="POST" action= "{{action('backend\AdminController@add_bangunan_blud')}}">
									{{ csrf_field() }}
									<div class="card">
										<div class="card-body">
