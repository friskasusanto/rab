			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li class="active">List Belanja Modal Pengadaan Gedung & Bangunan BLUD</li>
						</ol>
					</div>
							...
							<table class="table table-hover">
								...
								@if(count($list) != 0)
									...
									<tr>
										...
										<td class="text-right">
											<a href="{{action('backend\AdminController@edit_bangunan_blud', $l->id)}}">
											...
											<a href="{{action('backend\AdminController@delete_bangunan_blud', $l->id)}}">
											...
											<a href="{{action('backend\AdminController@detail_bangunan_blud', $l->id)}}">
