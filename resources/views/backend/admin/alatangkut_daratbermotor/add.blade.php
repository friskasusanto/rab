			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li class="active">Pengadaan Alat Angkut Darat Bermotor</li>
							<a href="{{action('backend\AdminController@list_alatbermotor')}}">
					...
					<div class="section-body contain-lg">
						...
						<div class="row">
							...
							<div class="col-lg-offset-1 col-md-10">
								<form class="form form-validate floating-label" novalidate="novalidate" method="POST" action= "{{action('backend\AdminController@add_alatbermotor')}}">
									{{ csrf_field() }}
									<div class="card">
										<div class="card-body">
