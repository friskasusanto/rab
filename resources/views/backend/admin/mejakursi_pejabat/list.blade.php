							...
							<table class="table table-hover">
								...
								@if(count($list) != 0)
									...
									<tr>
										...
										<td class="text-right">
											<a href="{{action('backend\AdminController@edit_mejakursi_pejabat', $l->id)}}">
											...
											<a href="{{action('backend\AdminController@delete_mejakursi_pejabat', $l->id)}}">
											...
											<a href="{{action('backend\AdminController@detail_mejakursi_pejabat', $l->id)}}">
