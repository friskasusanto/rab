			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li class="active">List Pengadaan Alat Angkut Darat Tak Bermotor</li>
						</ol>
					</div>
							...
							<table class="table table-hover">
								...
								@if(count($list) != 0)
									...
									<tr>
										...
										<td class="text-right">
											<a href="{{action('backend\AdminController@edit_alattakbermotor', $l->id)}}">
											...
											<a href="{{action('backend\AdminController@delete_alattakbermotor', $l->id)}}">
											...
											<a href="{{action('backend\AdminController@detail_alattakbermotor', $l->id)}}">
