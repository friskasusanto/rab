...
class CreatePengadaanAlatKalibrasisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pengadaan_alat_kalibrasis', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pengadaan_alat_kalibrasis');
    }
}
