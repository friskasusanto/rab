...
class CreatePengadaanAlatKantorDanRumahtanggasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pengadaan_alat_kantor_dan_rumahtanggas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pengadaan_alat_kantor_dan_rumahtanggas');
    }
}
