...
class CreatePengadaanAlatAngkutDaratTakbermotorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pengadaan_alat_angkut_darat_takbermotors', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pengadaan_alat_angkut_darat_takbermotors');
    }
}
